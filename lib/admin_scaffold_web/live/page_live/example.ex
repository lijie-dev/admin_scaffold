  ...
  def render(assigns) do
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-slate-600">展示如何使用 JSON 配置动态生成表单和表格</p>
      </div>
      <!-- 统计卡片 -->
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 mb-8">
        <div class="p-6 border-b border-slate-200">
          ...
          <p class="mt-1 text-sm text-slate-600">表单和表格都通过 JSON 配置生成</p>
        </div>
        ...
        <div class="p-6 space-y-4">
          <div class="border-l-4 border-blue-500 pl-4">
            ...
            <p class="text-sm text-slate-600 mt-1">
              ...
              <code class="bg-slate-100 px-1 rounded">
                AdminScaffoldWeb.Components.JsonForm.json_form
              </code>
              渲染动态表单
            </p>
          </div>
          ...
          <div class="border-l-4 border-green-500 pl-4">
            ...
            <p class="text-sm text-slate-600 mt-1">
              使用
              <code class="bg-slate-100 px-1 rounded">
                AdminScaffoldWeb.Components.JsonTable.json_table
              </code>
              渲染动态表格
            </p>
          </div>
          ...
          <div class="border-l-4 border-purple-500 pl-4">
            ...
            <p class="text-sm text-slate-600 mt-1">
              使用
              <code class="bg-slate-100 px-1 rounded">
                AdminScaffold.CodeGenerator.generate_crud/3
              </code>
              生成 CRUD 代码
            </p>
          </div>
