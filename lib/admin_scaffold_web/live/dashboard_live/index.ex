      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-lg transition-all">
          ...
          <div class="border-t border-slate-200 pt-4">
            <p class="text-sm font-medium text-slate-600 mb-2 uppercase tracking-wide">
              用户总数
            </p>
            <.link navigate={~p"/admin/users"} class="text-sm font-medium text-blue-600 hover:text-blue-700 inline-flex items-center gap-1 hover:gap-2 transition-all">
              查看全部 →
            </.link>
          </div>
        </div>
