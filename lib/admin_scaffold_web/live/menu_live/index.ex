        ...
        <div class="p-6 border-b border-slate-200">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold flex items-center gap-3 text-slate-900">
              <span class="w-1 h-6 bg-green-600"></span>
              菜单列表
            </h2>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full">
            <thead class="bg-slate-50 border-b border-slate-200">
              <tr>
                <th class="text-left px-6 py-3 text-sm font-semibold text-slate-700">
                  ID
                </th>
                <th class="text-left px-6 py-3 text-sm font-semibold text-slate-700">
                  菜单名称
                ...
                <th class="text-right px-6 py-3 text-sm font-semibold text-slate-700">
                  操作
                </th>
              </tr>
            </thead>
            <tbody id="menus" phx-update="stream">
              <tr :for={{dom_id, menu} <- @streams.menus} id={dom_id} class="group border-b border-slate-200 hover:bg-slate-50">
                ...
                <td class="px-6 py-4 text-sm text-slate-600">
                  <code class="font-mono text-pink-600">
                    <%= menu.path %>
                  </code>
                </td>
                <td class="px-6 py-4 text-sm text-slate-600">
                ...
                <td class="px-6 py-4">
                  <div class={if menu.status == 1, do: "px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded inline-block", else: "px-2 py-1 text-xs font-semibold text-slate-600 bg-slate-100 rounded inline-block"}>
