defmodule AdminScaffoldWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AdminScaffoldWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AdminScaffoldWeb.Gettext, "errors", msg, opts)
    end
  end
